var mui = require('../node_modules/material-ui'),
	React = require('../node_modules/material-ui/node_modules/react'),
	injectTapEventPlugin = require('../node_modules/react-tap-event-plugin'),
	RaisedButton = mui.RaisedButton,
	FlatButton = mui.FlatButton,
	Paper = mui.Paper,
	url = "//shopoffice.cloud-ops.net:8080/api/dressGame/interaction",
	loginUrl="//shopoffice.cloud-ops.net:8080/signup";
...
var FeatureTitle = React.createClass({
	render: function() {
		return typeof this.props.name !== "undefined" ?
			 ...
			 (<h1 className="feature__name feature__name--empty"><a href={this.props.loginUrl}>Login</a></h1>);
	}
});

var Login = React.createClass({
	render: function() {
		<h2 className="login"><a href={this.props.loginUrl}>Login</a></h2>
	}
})
...
var Product = React.createClass({
  render: function() {
  	if (this.props.id) {
		...
		<Login loginUrl={this.props.loginUrl} />
	}
  }
});
	...
	render: function() {
		return (
			<Paper zDepth={2} className="app" innerClassName="app__holder">
				<Product {...this.state.product} loginUrl={this.loginUrl} className="product" />
